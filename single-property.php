...
<?php 
    ...
    $baths    = function_exists('get_field') ? get_field('bath', $post_id) : '';
...
<section class="property__single section">
    ...
    <div class="property__single-container container">
        ...
        <div class="property__row grid">
            <?php if (has_post_thumbnail()) : ?>
            <div class="property__single-image">
        ...
        <div class="property__content-container grid">
            <div class="property__content grid">
                <div class="property__content-data">
            ...
            <div class="property__sticky grid">
                ...
                <div class="property__contact">
                    <div class="property__agents">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/reviews-icon-1.png" alt="Agent 1" class="property__agent-avatar">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/reviews-icon-2.png" alt="Agent 2" class="property__agent-avatar">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/reviews-icon-3.png" alt="Agent 3" class="property__agent-avatar">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/reviews-icon-4.png" alt="Agent 4" class="property__agent-avatar">
                    </div>

                    <span>10+ Featured Agents</span>
                    <div class="property__stars">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/stars-icon.png" alt="Star Icon" class="property__star">
                        <span>5.0</span>
                    </div>
                </div>
