		...
		<div class="feature__content grid">
					<a href="/" class="feature__card">
							...
							<div class="feature__card-image">
								...
								<span class="feature__location-text">For Investment</span>
							</div>
							...
							<div class="feature__card-data">
								...
								<h3 class="feature__title">Bel Air, LA</h3>
								</div>

								<!-- PROPERTY TITLE -->
								<h3 class="feature__property-title">The One</h3>
									...
									<div class="feature__card-icons">
										...
										<div class="feature__card-icon">
											...
											<span>2,780 sq.ft</span>
										</div>

									</div>

								<span class="feature__price">$690,000</span>
							</div>
					</a>
					<a href="/" class="feature__card">
							<!-- IMAGE -->
