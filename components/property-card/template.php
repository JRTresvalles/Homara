...
$beds     = function_exists('get_field') ? get_field('beds', $post_id) : '';
$baths    = function_exists('get_field') ? get_field('baths', $post_id) : '';
$sqft     = function_exists('get_field') ? get_field('sqft', $post_id) : '';
$type     = function_exists('get_field') ? get_field('type', $post_id) : '';
$image = $image ?: get_template_directory_uri() . '/assets/images/fallback.jpg';
/**
 * =========================
 * PREVIEW STATE
 * =========================
